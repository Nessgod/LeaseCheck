...
<%--<%@ Register TagPrefix="exp" TagName="UsuarioPerfil" Src="~/View/Sistema/Usuarios/Controls/Perfiles.ascx" %>--%>
<%--<%@ Register TagPrefix="exp" TagName="UsuarioHolding" Src="~/View/Sistema/Usuarios/Controls/Holding.ascx" %>
<%@ Register TagPrefix="exp" TagName="UsuarioEmpresa" Src="~/View/Sistema/Usuarios/Controls/Empresa.ascx" %>
<%@ Register TagPrefix="exp" TagName="UsuarioCenco" Src="~/View/Sistema/Usuarios/Controls/CentroCosto.ascx" %>--%>
    ...
    <asp:UpdatePanel runat="server" ID="udPanel"  UpdateMode="Conditional" >
        <ContentTemplate>
            ...
            <div class="row col-lg-12 col-md-12 col-xs-12 ">
	            ...
	            <div class="form-group col-lg-10 col-md-10 col-xs-12"> 
		            <WebControls:Textbox2 ID="txtFono" runat="server" onblur="validarNumero()"/>
