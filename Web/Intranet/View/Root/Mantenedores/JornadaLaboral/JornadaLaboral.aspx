<%@ Page Language="C#" MasterPageFile="~/Master/Simple.master" AutoEventWireup="true" CodeFile="JornadaLaboral.aspx.cs" Inherits="View_Mantenedores_JornadaLaboral_JornadaLaboral" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="cphBody" Runat="Server">
    <asp:UpdatePanel runat="server" ID="udPanel"  UpdateMode="Conditional" >
        <ContentTemplate>
            <div class="SubTitulos">Jornada Laboral</div>
