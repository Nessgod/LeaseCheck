<%@ Page Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="JornadasLaborales.aspx.cs" Inherits="View_Mantenedores_JornadaLaboral_JornadasLaborales" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="chpScript" runat="server">
    ...
    <script type="text/javascript">
        function abrir(query) {
            ...
            oWin.setUrl('<%=ResolveUrl("~/View/Root/Mantenedores/JornadaLaboral/JornadaLaboral.aspx") %>?query=' + query);
            oWin.show();
            bloqueaScroll(false);
        }
    ...
    <asp:UpdatePanel runat="server" ID="udPanel"  UpdateMode="Conditional" >
        <ContentTemplate>
            <rad:RadGrid2 ID="Grid" runat="server" onitemdatabound="Grid_ItemDataBound"> 
                <MasterTableView CommandItemDisplay="Top" DataKeyNames="jol_id" >
                    <CommandItemTemplate>
                        <div>
