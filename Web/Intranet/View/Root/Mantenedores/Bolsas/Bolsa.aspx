<%@ Page Language="C#" MasterPageFile="~/Master/Simple.master" AutoEventWireup="true" CodeFile="Bolsa.aspx.cs" Inherits="View_Mantenedores_Bolsas_Bolsa" %>
...
<asp:Content ID="ContenHeder" ContentPlaceHolderID="chpScript" runat="server">
     <script type="text/javascript" language="javascript">
        ...
        function closeWindow() {
         ...
         function abrirBolsa(query) {
             var oWin = $find("<%=rwiDetalle.ClientID %>");
             oWin.setUrl('<%=ResolveUrl("~/View/Root/Mantenedores/Bolsas/BolsaProducto.aspx") %>?query=' + query);
            oWin.show();
            bloqueaScroll(false);
        }
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <asp:UpdatePanel runat="server" ID="udPanel"  UpdateMode="Conditional" >
        <ContentTemplate>
            <div class="SubTitulos">Definición Tipo de Bolsas</div>
            ...
            <div class="row col-lg-12 col-md-12 col-xs-12 ">
	            ...
	            <div class="form-group col-lg-10 col-md-10 col-xs-12"> 
		            <rad:RadNumericBox2 ID="TxtInformes" runat="server" />
                    <asp:CustomValidator ID="CustomValidator2" runat="server" 
                        ControlToValidate="TxtInformes" 
                        ValidateEmptyText="true"
                        ClientValidationFunction="validaControl" 
                        ValidationGroup="Identidad" />
	            </div>
            ...
            <asp:Panel ID="pnlProducto" runat="server" Visible="true">
                ...
                <rad:RadGrid2 ID="Grid" runat="server">
                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="blp_id">
                        <CommandItemTemplate>
                            <div>
