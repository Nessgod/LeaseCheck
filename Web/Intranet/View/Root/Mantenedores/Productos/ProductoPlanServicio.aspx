<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Simple.master" AutoEventWireup="true" CodeFile="ProductoPlanServicio.aspx.cs" Inherits="View_Root_Mantenedores_Productos_ProductoPlanServicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    <asp:UpdatePanel runat="server" ID="udPanel"  UpdateMode="Conditional" >
        <ContentTemplate>
            <div class="SubTitulos">Servicios</div>
            <div class="row col-lg-12 col-md-12 col-xs-12 ">
                <div class="form-group col-lg-2 col-md-2 col-xs-12">
                    <label>Servicios:</label>
                </div>
                <div class="form-group col-lg-10 col-md-10 col-xs-12">
                    <rad:RadComboBox2 ID="cboServicio" runat="server" Width="100%" OnLoad="LoadControls"/>
                    <asp:CustomValidator ID="CustomValidator1" runat="server"
                        ControlToValidate="cboServicio"
