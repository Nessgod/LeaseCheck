<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Simple.master" AutoEventWireup="true" CodeFile="ProductoPlan.aspx.cs" Inherits="View_Root_Mantenedores_TipoPlan_ProductoPlan" %>
        ...
        <ContentTemplate>
            ...
            <div class="row col-lg-12 col-md-12 col-xs-12 ">
                ...
                <div class="form-group col-lg-10 col-md-10 col-xs-12">
                    <rad:RadComboBox2 ID="cboProducto" runat="server" Width="100%" OnLoad="LoadControls"/>
