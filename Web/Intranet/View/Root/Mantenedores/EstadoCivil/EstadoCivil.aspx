<%@ Page Language="C#" MasterPageFile="~/Master/Simple.master" AutoEventWireup="true" CodeFile="EstadoCivil.aspx.cs" Inherits="View_Mantenedores_EstadoCivil_EstadoCivil" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="cphBody" Runat="Server">
    <asp:UpdatePanel runat="server" ID="udPanel"  UpdateMode="Conditional" >
        <ContentTemplate>
            <div class="SubTitulos">Estado Civil</div>
