<%@ Page Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="EstadoCiviles.aspx.cs" Inherits="View_Mantenedores_EstadoCivil_EstadoCiviles" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="chpScript" runat="server">
    ...
    <script type="text/javascript">
        function abrir(query) {
            ...
            oWin.setUrl('<%=ResolveUrl("~/View/Root/Mantenedores/EstadoCivil/EstadoCivil.aspx") %>?query=' + query);
            oWin.show();
            bloqueaScroll(false);
        }
    ...
    <asp:UpdatePanel runat="server" ID="udPanel"  UpdateMode="Conditional" >
        <ContentTemplate>
            <rad:RadGrid2 ID="Grid" runat="server" onitemdatabound="Grid_ItemDataBound"> 
                <MasterTableView CommandItemDisplay="Top" DataKeyNames="eci_id" >
                    <CommandItemTemplate>
                     <div>
