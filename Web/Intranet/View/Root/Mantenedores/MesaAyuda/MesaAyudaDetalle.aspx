        ...
        <ContentTemplate>
            ...
            <fieldset class="border p-3 rounded">
                ...
                <div class="form-group">
                    <b>
                        <label id="lblCliente" runat="server" />
                    </b>
                </div>
                <div class="form-group">
                    <b>
                    ...
                    <div class="col-lg-5 col-md-5 col-xs-12">
                        <fieldset class="border p-3 rounded" id="CerrarTicket" runat="server">
                            ...
                            <div class="row form-group">
                                <label for="txtObservacionCierre" id="lblPrincipalObservacion" runat="server">Observación de Cierre <span class="text-danger">*</span></label>
                            ...
                            <div class="text-center mt-2">
                                <WebControls:PushButton ID="btnCerrarTicket" runat="server" Text="Cerrar Ticket" ValidationGroup="Cierre"
