        ...
        <ContentTemplate>
            <rad:RadTabStrip2 ID="ragTab" runat="server" MultiPageID="MultiPage" Skin="Bootstrap" RenderMode="Lightweight" SelectedIndex="0">
                <Tabs>
                    ...
                    <rad:RadTab Text="Datos de Pago" runat="server" PageViewID="rtvDatosPago" Visible="false" />
                </Tabs>
            </rad:RadTabStrip2>
            <rad:RadMultiPage ID="MultiPage" runat="server" SelectedIndex="0">
                ...
                <rad:RadPageView ID="rtvDatosPago" runat="server">
                    <br />
                    ...
                    <div class="row col-lg-12 col-md-12 col-xs-12 ">
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-xs-12">
                            <rad:RadComboBox2 ID="cboBanco" runat="server" OnLoad="LoadControls" Width="100%" Filter="Contains" AutoPostBack="true" OnSelectedIndexChanged="cboBanco_SelectedIndexChanged"/>
                        </div>
                    <div class="form-group col-lg-2 col-md-2 col-xs-12">
                        <label>Tipo Cuenta(*)</label>
                    </div>
                    <div class="form-group col-lg-4 col-md-4 col-xs-12">
                        <rad:RadComboBox2 ID="cboTipoCuenta" runat="server" OnLoad="LoadControls" Width="100%" Filter="Contains" />
                    </div>
                     </div>
                    ...
                    <div class="row col-lg-12 col-md-12 col-xs-12 ">
                        ...
                        <div class="form-group col-lg-10 col-md-10 col-xs-12">
                            <WebControls:TextBox2 ID="txtOtroBanco" runat="server" />
                        </div>
                    </div>
                    <div class="row col-lg-12 col-md-12 col-xs-12 ">
                        <div class="form-group col-lg-2 col-md-2 col-xs-12">
                        ...
                        <div class="form-group col-lg-10 col-md-10 col-xs-12">
                            <WebControls:TextBox2 ID="txtTitular" runat="server" />
                            <asp:CustomValidator ID="CustomValidator13" runat="server"
                                ControlToValidate="txtTitular"
                                ValidateEmptyText="true"
                                ClientValidationFunction="validaControl"
                                ValidationGroup="DatosLegales" />
                        </div>
                    </div>
                    <div class="row col-lg-12 col-md-12 col-xs-12 ">
                        <div class="form-group col-lg-2 col-md-2 col-xs-12">
                            <label>RUT Cuenta(*)</label>
                        </div>
                        <div class="form-group col-lg-10 col-md-10 col-xs-12">
                            <WebControls:TextBox2 ID="txtRutCuenta" runat="server" />
                            <asp:CustomValidator ID="CustomValidator14" runat="server"
                                ControlToValidate="txtRutCuenta"
                                ValidateEmptyText="true"
                                ClientValidationFunction="validaControl"
                                ValidationGroup="DatosLegales" />
                        </div>
                    ...
                    <div class="row col-lg-12 col-md-12 col-xs-12 ">
                        ...
                        <div class="form-group col-lg-10 col-md-10 col-xs-12">
                            <WebControls:TextBox2 ID="txtNumeroCuenta" runat="server" />
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 form-col-center">
                         ...
                         <WebControls:PushButton ID="btnGuardarDatosLegales" runat="server" Text="Guardar"
                             ValidationGroup="DatosLegales"
                             OnClick="btnGuardarDatosLegales_Click" />
