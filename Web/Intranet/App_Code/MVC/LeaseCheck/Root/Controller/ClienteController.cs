...
namespace LeaseCheck.Root.Controller
{
    public class ClienteController
    {
        ...
        // plan bolsas
        public List<ClientePlanBolsa> GetPlanBolsas(ClientePlanBolsa filtro)
        {
            List<ClientePlanBolsa> listado = new List<ClientePlanBolsa>();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    cmd.CommandText = "SEL_CLIENTE_PLAN_BOLSA";
                    cmd.Parameters.AddWithValue("@CLIENTE", filtro.cpb_cliente);
                    ...
                    using (SqlDataReader dr = Conexion.GetDataReader(cmd))
                    {
                        while (dr.Read())
                        {
                            ...
                            item.cpb_id = int.Parse(dr["CPB_ID"].ToString());
                            item.cpb_cliente = int.Parse(dr["CPB_CLIENTE"].ToString());
                            item.cpb_id_bolsa = int.Parse(dr["CPB_ID_BOLSA"].ToString());
                            item.cpb_fecha_creacion = DateTime.Parse(dr["CPB_FECHA_CREACION"].ToString());
                            item.cpb_fecha_hasta = DateTime.Parse(dr["CPB_FECHA_HASTA"].ToString());
                            item.cpb_cantidad = int.Parse(dr["CPB_CANTIDAD"].ToString());
                            item.cpb_administradores = int.Parse(dr["CPB_ADMINISTRADORES"].ToString());
                            item.bolsa_nombre = dr["NOMBRE"].ToString();
                            item.bolsa_cantidad = int.Parse(dr["CANTIDAD"].ToString());
                            item.bolsa_valor = int.Parse(dr["VALOR"].ToString());
        ...
        public ClientePlanBolsa GetClientePlanBolsa(ClientePlanBolsa filtro)
        {
            ClientePlanBolsa item = new ClientePlanBolsa();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                {
                    cmd.CommandText = "SEL_CLIENTE_PLAN_BOLSA";
                    cmd.Parameters.AddWithValue("@ID", filtro.cpb_id);
                    ...
                    using (SqlDataReader dr = Conexion.GetDataReader(cmd))
                    {
                        while (dr.Read())
                        {
                            ...
                            item.cpb_cliente = int.Parse(dr["CPB_CLIENTE"].ToString());
                            item.cpb_id_bolsa = int.Parse(dr["CPB_ID_BOLSA"].ToString());
                            item.cpb_fecha_desde = DateTime.Parse(dr["CPB_FECHA_DESDE"].ToString());
                            item.cpb_fecha_hasta = DateTime.Parse(dr["CPB_FECHA_HASTA"].ToString());
                            item.cpb_cantidad = int.Parse(dr["CPB_CANTIDAD"].ToString());
                            item.cpb_administradores = int.Parse(dr["CPB_ADMINISTRADORES"].ToString());
                            item.cpb_valor_bolsa = int.Parse(dr["CPB_VALOR_BOLSA"].ToString());

                            item.bolsa_nombre = dr["NOMBRE"].ToString();
                            item.bolsa_cantidad = int.Parse(dr["CANTIDAD"].ToString());
                            item.bolsa_administradores = int.Parse(dr["ADMINISTRADORES"].ToString());
                            item.bolsa_valor = int.Parse(dr["VALOR"].ToString());
                        }
                    }
        ...
        public Respuesta InsertClientePlanBolsa(ClientePlanBolsa item)
        {
            Respuesta respuesta = new Respuesta();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                {
                    int id = 0;
                    cmd = Conexion.GetCommand("INS_CLIENTE_PLAN_BOLSA");
                    cmd.Parameters.AddWithValue("@ID", id).Direction = System.Data.ParameterDirection.Output;
                    cmd.Parameters.AddWithValue("@CLIENTE", item.cpb_cliente);
                    cmd.Parameters.AddWithValue("@BOLSA", item.cpb_id_bolsa);
                    cmd.Parameters.AddWithValue("@FECHA_DESDE", item.cpb_fecha_desde);
                    cmd.Parameters.AddWithValue("@FECHA_HASTA", item.cpb_fecha_hasta);
                    cmd.Parameters.AddWithValue("@CANTIDAD", item.cpb_cantidad);
                    cmd.Parameters.AddWithValue("@ADIMINISTRADORES", item.cpb_administradores);
                    cmd.Parameters.AddWithValue("@VALOR_BOLSA", item.cpb_valor_bolsa);
        ...
        public Respuesta UpdateClientePlanBolsa(ClientePlanBolsa item)
        {
            Respuesta respuesta = new Respuesta();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    cmd = Conexion.GetCommand("UPD_CLIENTE_PLAN_BOLSA");

                    cmd.Parameters.AddWithValue("@ID", item.cpb_id);
                    cmd.Parameters.AddWithValue("@BOLSA", item.cpb_id_bolsa);
                    cmd.Parameters.AddWithValue("@FECHA_DESDE", item.cpb_fecha_desde);
                    cmd.Parameters.AddWithValue("@FECHA_HASTA", item.cpb_fecha_hasta);
                    cmd.Parameters.AddWithValue("@CANTIDAD", item.cpb_cantidad);
                    cmd.Parameters.AddWithValue("@ADMINISTRADORES", item.cpb_administradores);
        ...
        public Respuesta DeleteClientePlanBolsa(ClientePlanBolsa item)
        {
            Respuesta respuesta = new Respuesta();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    cmd = Conexion.GetCommand("DEL_CLIENTE_PLAN_BOLSA");
                    cmd.Parameters.AddWithValue("@ID", item.cpb_id);
        ...
        public List<ClienteProductoAdicional> GetClienteProductoAdicionales(ClienteProductoAdicional filtro)
        {
            List<ClienteProductoAdicional> listado = new List<ClienteProductoAdicional>();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    cmd.CommandText = "SEL_CLIENTE_PRODUCTO_ADICIONAL";
                    cmd.Parameters.AddWithValue("@CLIENTE", filtro.cpa_cliente);
                    ...
                    using (SqlDataReader dr = Conexion.GetDataReader(cmd))
                    {
                        while (dr.Read())
                        {
                            ...
                            item.cpa_id = int.Parse(dr["CPA_ID"].ToString());
                            item.cpa_cliente = int.Parse(dr["CPA_CLIENTE"].ToString());
                            item.cpa_producto_adicional = int.Parse(dr["CPA_PRODUCTO_ADICIONAL"].ToString());
                            item.cpa_fecha_desde = DateTime.Parse(dr["CPA_FECHA_DESDE"].ToString());
                            item.cpa_fecha_hasta = DateTime.Parse(dr["CPA_FECHA_HASTA"].ToString());
                            item.cpa_valor_producto_adicional = int.Parse(dr["CPA_VALOR_PRODUCTO_ADICIONAL"].ToString());

                            item.valor_producto = int.Parse(dr["VALOR_PRODUCTO"].ToString());
        ...
        public ClienteProductoAdicional GetClienteProductoAdicional(ClienteProductoAdicional filtro)
        {
            ClienteProductoAdicional item = new ClienteProductoAdicional();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                {
                    cmd.CommandText = "SEL_CLIENTE_PRODUCTO_ADICIONAL";
                    cmd.Parameters.AddWithValue("@ID", filtro.cpa_id);
        ...
        public Respuesta InsertClienteProductoAdicional(ClienteProductoAdicional item)
        {
            Respuesta respuesta = new Respuesta();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                {
                    int id = 0;
                    cmd = Conexion.GetCommand("INS_CLIENTE_PRODUCTO_ADICIONAL");
                    cmd.Parameters.AddWithValue("@ID", id).Direction = System.Data.ParameterDirection.Output;
                    cmd.Parameters.AddWithValue("@CLIENTE", item.cpa_cliente);
                    cmd.Parameters.AddWithValue("@PRODUCTO_ADICIONAL", item.cpa_producto_adicional);
                    cmd.Parameters.AddWithValue("@FECHA_DESDE", item.cpa_fecha_desde);
                    cmd.Parameters.AddWithValue("@FECHA_HASTA", item.cpa_fecha_hasta);
                    cmd.Parameters.AddWithValue("@VALOR_PRODUCTO_ADICIONAL", item.cpa_valor_producto_adicional);
        ...
        public Respuesta UpdateClienteProductoAdicional(ClienteProductoAdicional item)
        {
            Respuesta respuesta = new Respuesta();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    cmd = Conexion.GetCommand("UPD_CLIENTE_PRODUCTO_ADICIONAL");

                    cmd.Parameters.AddWithValue("@ID", item.cpa_id);
                    cmd.Parameters.AddWithValue("@PRODUCTO_ADICIONAL", item.cpa_producto_adicional);
                    cmd.Parameters.AddWithValue("@FECHA_DESDE", item.cpa_fecha_desde);
                    cmd.Parameters.AddWithValue("@FECHA_HASTA", item.cpa_fecha_hasta);
                    cmd.Parameters.AddWithValue("@VALOR_PRODUCTO_ADICIONAL", item.cpa_valor_producto_adicional);
        ...
        public Respuesta DeleteClienteProductoAdicional(ClienteProductoAdicional item)
        {
            Respuesta respuesta = new Respuesta();
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    cmd = Conexion.GetCommand("DEL_CLIENTE_PRODUCTO_ADICIONAL");
                    cmd.Parameters.AddWithValue("@ID", item.cpa_id);
        ...
        //Grid Productos
        public List<PlanProducto> GetPlanProductos(PlanProducto planProducto)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@ID", planProducto.plp_tipo_plan);
                ...
                using (SqlDataReader dr = Conexion.GetDataReader(cmd))
                {
                    while (dr.Read())
                    {
                        ...
                        item.plp_tipo_plan = int.Parse(dr["PLP_TIPO_PLAN"].ToString());
        ...
        public List<BolsaProducto> GetBolsaProductos(BolsaProducto bolsaProducto)
        {
            ...
            try
            {
                cmd.CommandText = "SEL_CLIENTE_BOLSA_PRODUCTO";
                cmd.Parameters.AddWithValue("@ID", bolsaProducto.blp_bolsa);
                ...
                using (SqlDataReader dr = Conexion.GetDataReader(cmd))
                {
                    while (dr.Read())
                    {
                        ...
                        item.blp_bolsa = int.Parse(dr["BLP_BOLSA"].ToString());
                        item.producto_nombre = dr["PRO_PRODUCTO"].ToString();
                        listado.Add(item);
                    }
                }
