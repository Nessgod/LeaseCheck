...
function navegador() {
    ...
    if (navigator.userAgent == 'Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; .NET4.0C; .NET4.0E; Tablet PC 2.0; HCTE; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR 3.5.30729; rv:11.0) like Gecko') {
        $.getScript("Css/SweetAlert/polyfill.min.js");
    }
}
